...
export class ExportService {
    ...
    getCurrentDate() {
        return this.datePipe.transform((new Date()), 'd MMM y, h:mm:ss a');
    }

    getCurrentDateString() {
        return this.datePipe.transform((new Date()), '_dMMy_hmmss');
    }
    ...
    generatepdf(tableId, docHeader, docName, doc){
        ...
        let options: any = {
            ...
            styles: { overflow: 'linebreak', columnWidth: 'wrap', lineColor: [0, 0, 0], lineWidth: 0.1, cellPadding:5 },
        ...
        //doc.addPage();
        doc.save(docName+this.getCurrentDateString()+'.pdf');
    }
    ...
    generatePortraitpdf(tableId, docHeader, docName){
        ...
        doc.text(400, 55, "Date: "+this.getCurrentDate());
        //self.footer(doc, 'p');
    ...
    generateLandscapepdf(tableId, docHeader, docName){
        ...
        doc.setFontStyle('normal');
        doc.text(40, 55, "Company Name: "+self.util.getCompanyName());
        doc.text(655, 55, "Date: "+this.getCurrentDate());
        //self.footer(doc, 'l');
        self.generatepdf(tableId, docHeader, docName, doc);
    }
    ...
    generatecsv(tableId, docName){
        ...
        return true;
        //    Angular2Csv(listArr, docName+self.dateStr, options);
    }
