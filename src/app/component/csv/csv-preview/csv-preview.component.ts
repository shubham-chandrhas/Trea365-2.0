...
export class CsvPreviewComponent implements OnInit {
  ...
  insertValidData() {
    ...
    switch (self.pageData.moduleType) {
      case "service":
        apiEndPoint = "service-type/csv/update";
        break;

      case "supplier":
        apiEndPoint = "admin/suppliers/csv/update";
        break;
      ...
      case "material":
        ...
        break;
      case "client":
        apiEndPoint = "client/csv/update";
        break;
      case "employee":
        apiEndPoint = "hr/employees/csv/update";
        break;
      default:
        break;
    }
