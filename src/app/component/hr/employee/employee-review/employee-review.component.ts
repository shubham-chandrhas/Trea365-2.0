    ...
    addEmp(){
        ...
        try {
            ...
            if (this.loggedInUser.role_id == '1'){
                ...
                url = reqObject.id != 0 ? 'hr/employees/edit/'+this.routStrArr[this.routStrArr.length - 1] : 'hr/employees/add/'+this.routStrArr[this.routStrArr.length - 1] ;
            } else{

                url = reqObject.id != 0 ? 'hr/employees/edit' : 'hr/employees/add' ;
            }
            ...
            let empFormData = {
                ...
                "wage_amount"       : parseFloat(reqObject.wage_amount),
                ...
                "permission_role_id"       : reqObject.permission_role_id,
                "role_name"       : reqObject.role_name
            };
