...
export const HRComponentList = [ CanAccessDirective, SubContractorListComponent, AddSubContractorComponent, SubContractorReviewComponent, TimesheetListComponent, EmployeeDialog ];
export const HREntryComponentList = [ EmployeeDialog ];
const commonRoutes: any = [
    { path: 'employee-list/:id', component: EmployeeListComponent, data: { title: 'HR - Employees'} },
    { path: 'employee-review', component: EmployeeReviewComponent, data: { title: 'HR - Employees'} },
    { path: 'new-employee', component: NewEmployeeComponent, data: { title: 'HR - Employees'} },
    { path: 'sub-contractor-list/:id', component: SubContractorListComponent, data: { title: 'HR - Subcontractor'} },
    { path: 'add-subcontractor', component: AddSubContractorComponent, data: { title: 'HR - Subcontractor'} },
    { path: 'subcontractor-review', component: SubContractorReviewComponent, data: { title: 'HR - Subcontractor'} },
]
const routes: Routes = [
    {   
        ...
        children: [
            ...commonRoutes,  
            { path: 'timesheet-list/:id', component: TimesheetListComponent, data: { title: 'HR - Timesheets'} },
        ],
