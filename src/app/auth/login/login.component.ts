  ...
  **/
  public onSubmit(form: FormGroup){
    ...
    if( form.valid ){
      ...
      this.util.setAuthData(reqData);
      if(!(reqData.Username.indexOf(' ') !== -1)){     // In case if you want
       // to remove this condition then need to add pattern for checking space between username.
